...
\restrict I9aiuXWG40j7BFMOd3SwJzJmcQTWCv0rYereuAmB9TGMCw65LJNawcem3o2I4iW

-- Dumped from database version 16.11 (Ubuntu 16.11-0ubuntu0.24.04.1)
-- Dumped by pg_dump version 16.11 (Ubuntu 16.11-0ubuntu0.24.04.1)

-- Started on 2026-03-31 21:42:07 -03
...
--
-- TOC entry 233 (class 1255 OID 17964)
...
--
-- TOC entry 225 (class 1255 OID 17985)
-- Name: sp_insert_chat_grupo_mensagem(integer, integer, integer, integer, text); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.sp_insert_chat_grupo_mensagem(IN p_codigo_grupo integer, IN p_codigo_empresa_grupo integer, IN p_codigo_usuario_remetente integer, IN p_codigo_empresa_usuario_remetente integer, IN p_mensagem text)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_codigo_mensagem INT;
BEGIN
    SELECT COALESCE(MAX(codigo_mensagem), 0) + 1
      INTO v_codigo_mensagem
      FROM tb_chat_grupo_mensagem
     WHERE codigo_empresa_grupo = p_codigo_empresa_grupo
       AND codigo_grupo = p_codigo_grupo;

    INSERT INTO tb_chat_grupo_mensagem (
        codigo_mensagem,
        codigo_grupo,
        ...
        v_codigo_mensagem,
        p_codigo_grupo,
        p_codigo_empresa_grupo,
        p_codigo_usuario_remetente,
        p_codigo_empresa_usuario_remetente,
        p_mensagem,
        NOW()
    );
END;
...
ALTER PROCEDURE public.sp_insert_chat_grupo_mensagem(IN p_codigo_grupo integer, IN p_codigo_empresa_grupo integer, IN p_codigo_usuario_remetente integer, IN p_codigo_empresa_usuario_remetente integer, IN p_mensagem text) OWNER TO postgres;
...
CREATE TABLE public.tb_chat_grupo_mensagem (
    ...
    codigo_grupo bigint NOT NULL,
    codigo_empresa_grupo bigint NOT NULL,
...
--
-- TOC entry 3432 (class 0 OID 17911)
-- Dependencies: 215
...
--
-- TOC entry 3437 (class 0 OID 17980)
-- Dependencies: 220
...
--
-- TOC entry 3436 (class 0 OID 17970)
-- Dependencies: 219
...
--
-- TOC entry 3433 (class 0 OID 17918)
-- Dependencies: 216
...
--
-- TOC entry 3434 (class 0 OID 17930)
-- Dependencies: 217
...
--
-- TOC entry 3435 (class 0 OID 17940)
-- Dependencies: 218
...
5	1	3	1	1	olá mundo	2026-03-31 21:35:45.047146
\.


--
-- TOC entry 3277 (class 2606 OID 17934)
...
--
-- TOC entry 3273 (class 2606 OID 17917)
...
--
-- TOC entry 3283 (class 2606 OID 17984)
...
--
-- TOC entry 3279 (class 2606 OID 17987)
...
ALTER TABLE ONLY public.tb_chat_grupo_mensagem
    ADD CONSTRAINT pk_grupo_mensagem PRIMARY KEY (codigo_mensagem, codigo_grupo, codigo_empresa_grupo);


--
-- TOC entry 3275 (class 2606 OID 17924)
...
--
-- TOC entry 3286 (class 2606 OID 17988)
...
--
-- TOC entry 3287 (class 2606 OID 17952)
...
--
-- TOC entry 3285 (class 2606 OID 17935)
...
--
-- TOC entry 3288 (class 2606 OID 17975)
...
--
-- TOC entry 3284 (class 2606 OID 17925)
...
-- Completed on 2026-03-31 21:42:07 -03

--
-- PostgreSQL database dump complete
--

\unrestrict I9aiuXWG40j7BFMOd3SwJzJmcQTWCv0rYereuAmB9TGMCw65LJNawcem3o2I4iW
